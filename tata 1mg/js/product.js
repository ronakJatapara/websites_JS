...
//                                     <div id="rate1" class="d-flex justify-content-center align-items-center">
...
//                             </div>
//                             <font id="mrp">
//                                 MRP :- <font id="line">${el.mrp}</font><font id="off">${el.off}</font>
//                             </font>
...
//     let storeitems = document.getElementById("row6");
//     let product=document.querySelectorAll(".product");
//     let pname=storeitems.querySelector("h5");


//     for(let i=0;i<pname.length;i++)
//     {
//         let match=product[i].querySelector("h5")[0];
